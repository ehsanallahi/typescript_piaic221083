...
// step 2 
const aliens_color : string ="yelle";
...
// for green
const green_alien :string =" green";
...
// for yellow
const yellow_alien :string =" yellow";
...
const username :string[] = ['admin', 'ehsan','bilal','hamza', 'eric'] 
...
const current_users :string [] = [' Ali' , 'Ahmad' , 'Wahaj' , 'Taha', 'Wasif']

const new_users : string [] = ['Hamza' , 'Ehsan' , 'Usama' ,'Taha', 'Talha'];
...
const favoritePizza : string []= [ ' Malai Boti', ' Kebab Crust' ,'Deep Dish']
...
const magicianName: string[] = ['David Copperfield', 'Harry Houdini', 'Penn Jillette', 'Teller'];
...
function shows_magicians(magicians: string[]): void {
  for (const magician of magicians) {
    console.log(magician);
  }
}
...
const magiciansNames: string[] = ['David Copperfield', 'Harry Houdini', 'Penn Jillette', 'Teller'];
...
function createCar(manufacturer: string, modelName: string, ...args: { [key: string]: any }[]): Record<string, any> {
